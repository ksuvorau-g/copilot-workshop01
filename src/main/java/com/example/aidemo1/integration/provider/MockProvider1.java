...
import com.example.aidemo1.integration.client.MockProvider1Client;
...
/**
 * Mock exchange rate provider implementation #1.
 * 
 ...
 * external providers but generates random rates.</p>
 * 
 * <h2>Configuration</h2>
 * <p>Can be enabled/disabled via the {@code mock.provider1.enabled} property.</p>
 * 
 * <h2>Priority</h2>
 ...
 * @see MockProvider1Client
 */
@Slf4j
@Component
@ConditionalOnProperty(name = "mock.provider1.enabled", havingValue = "true", matchIfMissing = true)
public class MockProvider1 implements ExchangeRateProvider {
    ...
    private final MockProvider1Client client;
    
    public MockProvider1(MockProvider1Client client) {
        this.client = client;
    }
