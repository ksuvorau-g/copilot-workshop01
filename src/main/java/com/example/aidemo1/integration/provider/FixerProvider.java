...
/**
 * Exchange rate provider implementation for Fixer.io.
 * 
 * <p>Fetches real exchange rates from Fixer.io API with automatic retry logic
...
public class FixerProvider implements ExchangeRateProvider {
    ...
    private static final String PROVIDER_NAME = "Fixer";
    private static final int PRIORITY = 100;
    
    private final FixerClient client;
    
    public FixerProvider(FixerClient client) {
        this.client = client;
    }
    ...
    public ExchangeRate fetchRate(String from, String to) {
        ...
        try {
            FixerResponse response = client.getExchangeRate(from, to);
