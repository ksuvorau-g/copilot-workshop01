...
/**
 * Tests for MockProvider2Controller.
 */
@WebMvcTest(MockProvider2Controller.class)
@AutoConfigureMockMvc(addFilters = false)
class MockProvider2ControllerTest {
    ...
    void testGetExchangeRate_Success() throws Exception {
        mockMvc.perform(get("/mock/provider2/rate")
                ...
                .andExpect(jsonPath("$.provider").value("Mock Provider 2"));
    }
