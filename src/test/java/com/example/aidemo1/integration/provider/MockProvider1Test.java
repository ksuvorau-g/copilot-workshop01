...
class MockProvider1Test {

    @Mock
    private MockProvider1Client client;
    ...
    void testFetchRate_Success() {
        ...
        assertEquals("Mock Provider 1", result.getProvider());
    ...
    void testGetProviderName() {
        assertEquals("Mock Provider 1", provider.getProviderName());
    }
