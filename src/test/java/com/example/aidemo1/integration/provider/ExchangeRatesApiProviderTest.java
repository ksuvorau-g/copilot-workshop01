...
class ExchangeRatesApiProviderTest {
    ...
    private ExchangeRatesApiResponse successResponse;

    @BeforeEach
    void setUp() {
        successResponse = new ExchangeRatesApiResponse();
    ...
    void testFetchRate_Success() {
        ...
        assertEquals("ExchangeRatesAPI", result.getProvider());
    ...
    void testGetProviderName() {
        assertEquals("ExchangeRatesAPI", provider.getProviderName());
    }
