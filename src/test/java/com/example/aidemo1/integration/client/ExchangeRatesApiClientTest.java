...
class ExchangeRatesApiClientTest {
    ...
    @BeforeEach
    void setUp() {
        client = new ExchangeRatesApiClient(restTemplate, BASE_URL, API_KEY);
    }
    ...
    void testGetExchangeRate_Success() {
        ...
        when(restTemplate.getForObject(any(String.class), eq(ExchangeRatesApiResponse.class)))
                .thenReturn(mockResponse);

        ExchangeRatesApiResponse result = client.getExchangeRate("USD", "EUR");
    ...
    void testGetExchangeRate_ApiError() {
        ...
        ExchangeRatesApiResponse.ErrorInfo errorInfo = new ExchangeRatesApiResponse.ErrorInfo();
        errorInfo.setMessage("Invalid API key");
